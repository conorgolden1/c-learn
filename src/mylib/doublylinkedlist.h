...
/**
 * @brief Removes and returns the element at the specified position in the doubly linked list.
 *
 * @param list A pointer to the list.
...
/**
 * @brief Returns the element at the specified position in the doubly linked list without removing it.
 *
 * @param list A pointer to the list.
